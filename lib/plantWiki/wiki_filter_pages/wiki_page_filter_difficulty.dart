    ...
    return Scaffold(
      ...
      body: GridView(
        ...
        children: [
          FilterCard(
            title: 'Easy',
            imagePath: 'lib/plantWiki/wiki_images/difficulty/Wiki-Difficulty-1.png',
          ...
          FilterCard(
            title: 'Medium',
            imagePath: 'lib/plantWiki/wiki_images/difficulty/Wiki-Difficulty-2.png',
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const PlantFilterResultPage(
          ...
          FilterCard(
            title: 'Difficult',
            imagePath: 'lib/plantWiki/wiki_images/difficulty/Wiki-Difficulty-3.png',
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const PlantFilterResultPage(
